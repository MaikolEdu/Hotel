	  ...
	  <p>		    Comodidad y diseño. Disfrute de esta habitación creada pensando en usted.<br />
	    Cuenta con todos los servicios   necesarios para tener una estancia inolvidable: <br />
		  ...
		  <p>		    <a href="habitacion_simple.php">HABITACIÓN SIMPLE</a><br />
		    <a href="habitacion_doble.php">HABITACIÓN DOBLE<br />
            </a><a href="suite_junior.php">SUITE JUNIOR<br />
            </a><a href="habitacion_matrimonial.php">SUITE MATRIMONIAL</a><a href="habitacion_triple.php"></a><a href="suite_junior.php"> </a><br />
          <a href="suite_ejecutiva.php">SUITE EJECUTIVA</a></p>
	</div>
		<div id="box2" style="width:400px; margin-left:20px; ">
        
         <div id="makeMeScrollable"><img src="archivos/simple2.jpg" alt="" width="429" height="286" />
         </div>
