...
<div id="wrapper" class="container">
  ...
  <div id="featured-wrapper">
	<div id="box1" >
	  <h2>HABITACIÓN SIMPLE<br />
	  </h2>
	  <p>		    Comodidad y diseño. Disfrute de esta habitación creada pensando en usted y sus necesidades. Cuenta con todos los servicios   necesarios para tener una estancia inolvidable: <br />
		  </p>
		  <ul>
		  ...
		  <p><a href="habitacion_doble.php">HABITACIÓN DOBLE</a><br />
		    <a href="habitacion_matrimonial.php">HABITACIÓN MATRIMONIAL</a>		    <br />
		    <a href="suite_junior.php">SUITE JUNIOR</a><br />
      <a href="suite_ejecutiva.php">SUITE EJECUTIVA</a></p>
	</div>
		<div id="box2" style="width:400px; margin-left:20px; ">
        
         <div id="makeMeScrollable">
         	<img src="fotos/simple01.jpg" alt="" width="430" height="286" />
			<img src="fotos/simple02.jpg" alt="" width="430" height="286" />
         </div>
